...
The six things FridgeBoard stores, what each one means, and why the design is shaped the way it is.
...
FridgeBoard decides who you are in exactly this order and stops at the first
hit:
...
What FridgeBoard does guarantee is that **cooperating participants cannot
