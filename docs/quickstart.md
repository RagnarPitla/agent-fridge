...
```bash
npx fridgeboard init          # try it with no install
npm install -g fridgeboard    # machine-wide
...
```
fridgeboard 0.1.0  protocol wcp/0.1  node v22.22.3  darwin/arm64
```
...
git commit -m "Add FridgeBoard coordination"
```
...
FridgeBoard never guesses who you are. It resolves identity in exactly this
...
```
<!-- GENERATED by fridgeboard 0.1.0 at 2026-08-19T13:39:31.529Z state:7183cc2dcdf4
